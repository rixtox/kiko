...
<section id="respond" class="respond-form">
	...
	<p>
	  <input name="submit" type="submit" id="submit" class="*button *blue-button" tabindex="5" value="<?php _e('Submit', 'bonestheme'); ?>" />
